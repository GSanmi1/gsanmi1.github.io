...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420101906.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420102246.png' | relative_url }}" text-align="center"/>
</div>

E interceptamos la request:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420102109.png' | relative_url }}" text-align="center"/>
</div>

Y cambuamos el contenido del parámetro **stockApi** y pones nuestra dirección preferente:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420102435.png' | relative_url }}" text-align="center"/>
</div>

Recordamos que debemos mantener el formato de codificación de URL y aparecerá:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420102503.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420102826.png' | relative_url }}" text-align="center"/>
</div>

De la siguiente manera:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420103053.png' | relative_url }}" text-align="center"/>
</div>

Para comprobar que nuestra petición ha tenido el efecto deseado volvemos a intentar ver el panel de admin:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420103158.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420111003.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420111615.png' | relative_url }}" text-align="center"/>
</div>

Y como payload:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420111646.png' | relative_url }}" text-align="center"/>
</div>

De esta forma finalmente

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420114623.png' | relative_url }}" text-align="center"/>
</div>

Así, llevamos a cabo la siguiente request:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420114924.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420171329.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420172441.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420172827.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420173122.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420173254.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220503172408.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220503172719.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220503172838.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220503173002.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220503173926.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420181326.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220420182330.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220511141842.png' | relative_url }}" text-align="center"/>
</div>

Y vamos a la ventana del cliente de BurpCollaborator y al darle a pullnow observamos que:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220511141918.png' | relative_url }}" text-align="center"/>
</div>

...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220325111328.png' | relative_url }}" text-align="center"/>
</div>

modificar el precio de 133700 a 100 para posteriormente proceder a la compra.

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220325111504.png' | relative_url }}" text-align="center"/>
</div>

<br />

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220325111532.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427144849.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427145203.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427145359.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427152226.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427152614.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427153434.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427153536.png' | relative_url }}" text-align="center"/>
</div>

Y le damos al tipo de payload: Null payload

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427153554.png' | relative_url }}" text-align="center"/>
</div>

Y comenzamos el ataque. Tal y como predecíamos, en algún momento el valor del carrito pasará a ser negativo:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427153627.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427193256.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427193619.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220425230948.png' | relative_url }}" text-align="center"/>
</div>

De forma que nos aparecerá un botón "Session is not running" y le daremos:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220425231044.png' | relative_url }}" text-align="center"/>
</div>

Empezará un escaneo y después de un tiempo empezará a salir información acerca del sitio web.

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220425231150.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220425231328.png' | relative_url }}" text-align="center"/>
</div>

Cuyo acceso está restringido:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220425231351.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427204458.png' | relative_url }}" text-align="center"/>
</div>

Así, cambiamos nuestro email a @dontwannacry.com y tendremos acceso al panel de adminstrador

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427204719.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427221240.png' | relative_url }}" text-align="center"/>
</div>

utilizamos nuestros datos, cambiamos nuestra contraseña e interceptamos la request:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427221344.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427221442.png' | relative_url }}" text-align="center"/>
</div>

Al enviar la request obtenemos que:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427221505.png' | relative_url }}" text-align="center"/>
</div>

Y al logearnos con las nuevas credenciales del administrador conseguimos logearnos como el mismo:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427221547.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427222442.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427222514.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427222609.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220331102118.png' | relative_url }}" text-align="center"/>
</div>

obtenemos la siguiente request

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220331102348.png' | relative_url }}" text-align="center"/>
</div>

Y al continuar automáticamente se realiza otra request para seguir a "order-confirmation":

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220331102434.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220331103042.png' | relative_url }}" text-align="center"/>
</div>

y le damos a enter completando el laboratorio.

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220331103053.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220428143622.png' | relative_url }}" text-align="center"/>
</div>

Y al aceptar la petición entraremos en uina redirección en la que nos preguntarán por el rol del usuario.

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220428144058.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220428144132.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220331192737.png' | relative_url }}" text-align="center"/>
</div>

<br />

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220331192756.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220428150912.png' | relative_url }}" text-align="center"/>
</div>

Canjear el contenido, cambiar el email,

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220428150940.png' | relative_url }}" text-align="center"/>
</div>

volver a suscribirnmos a la revista y obtener así de nuevo el código validado

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220428151002.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220510110731.png' | relative_url }}" text-align="center"/>
</div>

Seguidamente, volvemos a la pestaña "Details" y debajo de "Rule Actions" > "add" y "Run a Macro"

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220510110817.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220510111520.png' | relative_url }}" text-align="center"/>
</div>

- Seguidamente, sobre el MacroEditor pinchamos sobre la GET request de confiramción y le damos a configurar item:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220510111705.png' | relative_url }}" text-align="center"/>
</div>

Se abrirá el menú de configuración del macro y pulsaremos sobre add para añadir un parámetro:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220510111907.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220510112335.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220510123443.png' | relative_url }}" text-align="center"/>
</div>

Y le damos a Test Macro:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220510123934.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220510125448.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220628144717.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220628144808.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220628145143.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220628151527.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220628152031.png' | relative_url }}" text-align="center"/>
</div>

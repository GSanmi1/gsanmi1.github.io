...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220114101535.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220205202228.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220114110601.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220116202019.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220116203604.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220116205657.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220116213432.png' | relative_url }}" text-align="center"/>
</div>

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220116213501.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220131104402.png' | relative_url }}" text-align="center"/>
</div>

Luego podemos acudir a ella con el comando session -i o sessions.

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220114110714.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117163125.png' | relative_url }}" text-align="center"/>
</div>
...
- **data**: El directorio 'data' contiene archivos editables utilizados por Metasploit para almacenar los binarios necesarios para ciertos elementos como exploits, wordlists, imágenes, etc. 
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117163306.png' | relative_url }}" text-align="center"/>
    </div>
...
- **documentation**: En la carpeta documentation podemos encontrar documentación disponible del entorno de trabajo de Metasploit.
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117164506.png' | relative_url }}" text-align="center"/>
    </div>
...
- **lib**: El directorio lib contiene el código que soporta la base del entorno de trabajo.
	...
	<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117165416.png' | relative_url }}" text-align="center"/>
    </div>
...
- **modules**: Es donde se encuentran los modules de MSF para los exploits; auxiliary, post modules, payloads, encoders, etc.
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117165553.png' | relative_url }}" text-align="center"/>
    </div>
...
- **plugins**: los plugins para añadir funcionalidades al comportamiento del software Metasploit y pueden ser requeridos para que Metasploit interactúe con aplicaciones externas como nmap.
	...
	<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117165740.png' | relative_url }}" text-align="center"/>
    </div>
...
- **scripts**: Contiene elementos como Meterpreter y otros scripts utilizados en payloads.
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117165817.png' | relative_url }}" text-align="center"/>
    </div>
...
- **Tools**: Utilidades de la línea de comandos.
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117170130.png' | relative_url }}" text-align="center"/>
    </div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117170827.png' | relative_url }}" text-align="center"/>
    </div>
...
- **/usr/share/metasploit-framework/modules/**
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117171611.png' | relative_url }}" text-align="center"/>
    </div>

-  **~/.msf4/modules/**

    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117171850.png' | relative_url }}" text-align="center"/>
    </div>
...
- **Exploits**: Un Exploit es un tipo de módulo que utiliza un payload. Es decir, que utiliza un fragmento de código adicional. Estos pueden encontrarse en: **/usr/share/metasploit-framework/modules/exploits**:
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117172617.png' | relative_url }}" text-align="center"/>
    </div>
...
- **Auxiliary**: Los módulos auxiliares son aquellos que se utilizan para generar acciones que tienen un propósito auxilar a la tarea principal. Entre este tipo de tareas encontramos: Escaneo de puertos, fuzzers, sniffers y más. Acciones que pueden ayudarnos a elegir mejor el tipo de exploit, de payload, etc.
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117173117.png' | relative_url }}" text-align="center"/>
    </div>
...
- **Otros**: Metasploite te da la opción de cargar módulos  de forma externa en "runtime" (cuando el programa se está ejecutando) con el modificador **-m**. 
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117192944.png' | relative_url }}" text-align="center"/>
    </div>
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220117192802.png' | relative_url }}" text-align="center"/>
    </div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220119191744.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220119233833.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220121164120.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220121164325.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220121170052.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220121172450.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220122152147.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220122152404.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220122152534.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220122152645.png' | relative_url }}" text-align="center"/>
</div>
...
- **help**: help muestra una lista de comandos que se pueden utilizar y una descripción de los mismos.
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220118123712.png' | relative_url }}" text-align="center"/>
    </div>

	Además, pasándole un comando como argumento a help te despliega una ayuda sobre cómo utilizar dicho comando:

    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220118124934.png' | relative_url }}" text-align="center"/>
    </div>
...
- **show sessions**: Desde Metasploit podemos listar el número de sessiones que tenemos abiertas con meterpreter 
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220118131737.png' | relative_url }}" text-align="center"/>
    </div>
...
- **multi/handler**: El módulo *multi/handler* es un exploit de tipo **handler**. 
	...
	**Antes de levantar un multi/handler hace falta configurar adecuadamente el payload que definirá el tipo de conexión que se tiene levanta o que se quiere levantar contra la máquina víctima**. Es decir, que si nosotros estamos escuchando un payload configurado como meterpreter_reverse__tcp, el multihandler debe tener configurado un payload equivalente al de esta conexión para que sea compatible.
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220119164920.png' | relative_url }}" text-align="center"/>
    </div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220122185202.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220122185433.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220122191250.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220122230933.png' | relative_url }}" text-align="center"/>
</div>

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220122231000.png' | relative_url }}" text-align="center"/>
</div>

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220122231018.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220123003356.png' | relative_url }}" text-align="center"/>
</div>

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220123003115.png' | relative_url }}" text-align="center"/>
</div>

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220123003540.png' | relative_url }}" text-align="center"/>
</div>

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220123003635.png' | relative_url }}" text-align="center"/>
</div>
...
1. **MySQL**.
	...
	**Fuerza bruta utilizando fichero PASS_FILE** ->  auxiliary/scanner/mysql/mysql_login
	...
	<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220125150831.png' | relative_url }}" text-align="center"/>
    </div>
	...
	**Conecta con credenciales y hace una enumeración de ficheros** -> auxiliary/admin/mysql/mysql_file_enum
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220125152301.png' | relative_url }}" text-align="center"/>
    </div>
	...
	**Volcado de esquema de todas las tablas de la base de datos** -> auxiliary/scanner/mysql/mysql_schemadump
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220125153254.png' | relative_url }}" text-align="center"/>
    </div>
...
2. **FTP**.
	...
	**Fuerza bruta usando determinadas características** -> auxiliary/scanner/ftp/ftp_login 
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220125161322.png' | relative_url }}" text-align="center"/>
    </div>
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220125161733.png' | relative_url }}" text-align="center"/>
    </div>
...
3. **Samba**: Samba es un servidor que opera sobre el protocolo SMB y que se utiliza para conectar.
	...
	**Fuerza bruta de Samba usando PASS_FILE** -> auxiliary/scanner/smb/smb_login
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220125170435.png' | relative_url }}" text-align="center"/>
    </div>
...
4. **SSH**.
	...
	**Fuerza bruta con SSH** -> auxiliary/scanner/ssh/ssh_login
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220125192059.png' | relative_url }}" text-align="center"/>
    </div>
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220125192259.png' | relative_url }}" text-align="center"/>
    </div>
...
5. **Telnet**.
	...
	**Fuerza bruta Telnet** -> auxiliary/scanner/telnet/telnet_login    
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220125194004.png' | relative_url }}" text-align="center"/>
    </div>
...
6. **VNC**.
	...
	**Fuerza bruta de VNC usando PASS_FILE** -> auxiliary/scanner/vnc/vnc_login
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220126144954.png' | relative_url }}" text-align="center"/>
    </div>
...
Los **servicios disponibles** son: 
 ...
 <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220126150810.png' | relative_url }}" text-align="center"/>
    </div>
...
La mayoría son iguales, veámos algún ejemplo. En las opciones, las variables básicas son:
  ...
  <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220126180803.png' | relative_url }}" text-align="center"/>
    </div>
...
Por ejemplo, introducimos RedirectURL= https://www.google.com de manera que, cuando corremos:
 ...
 <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220126182124.png' | relative_url }}" text-align="center"/>
    </div>

Y al conectarnos desde la máquina obtenemos:

 <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220126182539.png' | relative_url }}" text-align="center"/>
    </div>
...
Otros módulos del mismo poseen más opciones como modificar las contraseñas, cambios de protocolo etc. 
 ...
 <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220118101845.png' | relative_url }}" text-align="center"/>
    </div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220127111031.png' | relative_url }}" text-align="center"/>
    </div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220127111225.png' | relative_url }}" text-align="center"/>
    </div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220127115632.png' | relative_url }}" text-align="center"/>
    </div>

Podemos explorar, una vez finalizado el proceso, los resultados con wmap_vulns -l:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220127115948.png' | relative_url }}" text-align="center"/>
    </div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220127140932.png' | relative_url }}" text-align="center"/>
    </div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220127143133.png' | relative_url }}" text-align="center"/>
    </div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220127143833.png' | relative_url }}" text-align="center"/>
    </div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220127155329.png' | relative_url }}" text-align="center"/>
    </div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220127174730.png' | relative_url }}" text-align="center"/>
    </div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220127175113.png' | relative_url }}" text-align="center"/>
    </div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220127180452.png' | relative_url }}" text-align="center"/>
    </div>

Seguidamente ejecutamos el .exe en windows y:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220127180652.png' | relative_url }}" text-align="center"/>
    </div>
...
- **env**: El módulo **env** es un módulo que recopila las variables de entorno del sistema operativo que corre en la máquina víctima.
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120143121.png' | relative_url }}" text-align="center"/>
    </div>
...
- **firefox_creds**: El modulo *firefox_creds* recopila credenciales (contraseñas, cookies) relacionadas con firefox 
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120144932.png' | relative_url }}" text-align="center"/>
    </div>
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120145518.png' | relative_url }}" text-align="center"/>
    </div>
...
- **ssh_creds**: Este módulo recopilará la información del directorio **.ssh** de la máquina víctima. Además, ficheros como knwon_hosts, authorized_keys también so descargados.
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120145836.png' | relative_url }}" text-align="center"/>
    </div>
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120150152.png' | relative_url }}" text-align="center"/>
    </div>
...
- **execute**: Meterpreter es una herramienta que abre su propio entorno con sus propios comandos que hace que meterpreter genere instrucciones que inyecta en la máquina vulnerable. No se trata de un acceso directo a una terminal del sistema operativo de la máquina objetivo.
	...
	Para ello, para introducir comandos propios del sistema operativo, disponiemos del comando **execute**, que inyecta un comando propio del sistema operativo de la máquina en cuestión. Podemos por ejemplo crear un fichero:
     ...
     <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120152500.png' | relative_url }}" text-align="center"/>
    </div>

     <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120152515.png' | relative_url }}" text-align="center"/>
    </div>
...
- **check_malware**: Este módulo nos permite analizar si un fichero es malware subiéndolo a VirusTotal. Se tiene que correr desde Metasploit, no desde meterpreter a modo de módulo tipo POST.
     ...
     <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120155741.png' | relative_url }}" text-align="center"/>
    </div>
...
- **keylog_recorder**: Se trata de una herramienta que captura las teclas pulsadas por el usario en el teclado conectado a la máquina víctima.
     ...
     <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120161349.png' | relative_url }}" text-align="center"/>
    </div>

     <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120161827.png' | relative_url }}" text-align="center"/>
    </div>
...
- **arp_scanner**: Efectúa un escaneo arp para ver qué máquinas (IP y MAC) se han puesto en contacto con la máquina. Se corre utilizando un módulo post:
     ...
     <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120165858.png' | relative_url }}" text-align="center"/>
    </div>
...
- **checkvm**: Este módulo checkea si la máquina víctima es o no una máquina virtual.
     ...
     <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120170059.png' | relative_url }}" text-align="center"/>
    </div>
...
- **credential_collector**: Recopilar credenciales
     ...
     <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120171501.png' | relative_url }}" text-align="center"/>
    </div>
	...
	**El valor de la contraseña hash no se cifra antes de que se almacene en la base de datos. Cuando un miembro intenta iniciar sesión, el módulo de personalización toma la contraseña proporcionada, realiza un hash unidireccional similar y lo compara con el valor de la base de datos. Si las contraseñas coinciden, entonces el inicio de sesión es exitoso.**
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120193257.png' | relative_url }}" text-align="center"/>
    </div>
...
- **enum_applications**: Listado de aplicaciones instaladas
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120173756.png' | relative_url }}" text-align="center"/>
    </div>
...
- **enum_logged_on_users**: Listado de usuarios que han iniciado sesión
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120171602.png' | relative_url }}" text-align="center"/>
    </div>
...
- **enum_shares**: Listado de recursos compartidos. 
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120174644.png' | relative_url }}" text-align="center"/>
    </div>
...
- **usb_history**: Dispositivos USB conectados 
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120194110.png' | relative_url }}" text-align="center"/>
    </div>
...
- Comprobar si es una VM ->**post/linux/gather/checkvm**
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120194848.png' | relative_url }}" text-align="center"/>
    </div>
...
- Listado de ficheros de configuración de aplicaciones -> **post/linux/gather/enum_configs**
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120220013.png' | relative_url }}" text-align="center"/>
    </div>
...
- Recopilar estado de red y equipos -> post/linux/gather/**enum_network**
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120220037.png' | relative_url }}" text-align="center"/>
    </div>
...
- Software Blue Team -> post/linux/gather/**enum_protections**
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120221948.png' | relative_url }}" text-align="center"/>
    </div>
...
- Información de sistema -> post/linux/gather/**enum_system**
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120222443.png' | relative_url }}" text-align="center"/>
    </div>
...
- Registro de comandos (shell, mysql, vim...) -> post/linux/gather/**enum_users_history**
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220120223616.png' | relative_url }}" text-align="center"/>
    </div>
...
- En primer lugar, utilizamos la máquina WIndowsploitable y utilizamos un exploit contra ella, por ejemplo EternalBlue, con un payload de Meterpreter:
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220212121425.png' | relative_url }}" text-align="center"/>
    </div>
...
- Seguidamente, utilizamos el comando que tiene meterpreter para generar persistencia:
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220212121710.png' | relative_url }}" text-align="center"/>
    </div>
...
- Así pues, supongámos que perdemos la sesión actual que tenemos abierta con Meterpreter. Entonces, sabemos que el payload que se ha guardado en el ordenador a modo de script es un reverse shell y por tanto podemos recuperar la conexioń levantando un **multihandler** y configurando el payload adecuadamente de forma que coincida con el payload que está pidiendo una conexión desde la máquina víctima.
    ...
    <div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/M6/Pasted image 20220212122208.png' | relative_url }}" text-align="center"/>
    </div>

...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220401113914.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220401114008.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220401120135.png' | relative_url }}" text-align="center"/>
</div>

<br />

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220401120159.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220401120313.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220401162926.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220401171214.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220401171257.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220401171451.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220401171910.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220401172228.png' | relative_url }}" text-align="center"/>
</div>

Y ahí tenemos las credenciales válidas.

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220401172313.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220401175646.png' | relative_url }}" text-align="center"/>
</div>

Y para las password:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220401175530.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220402115510.png' | relative_url }}" text-align="center"/>
</div>

Y para los nombres de usuario:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220402121047.png' | relative_url }}" text-align="center"/>
</div>

Así, empleamos tales listas para hacer un ataque de fuerza bruta.

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220402124913.png' | relative_url }}" text-align="center"/>
</div>

<br />

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220402125014.png' | relative_url }}" text-align="center"/>
</div>

Y finalmente obtenemos:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220402125544.png' | relative_url }}" text-align="center"/>
</div>

Y habríamos resuelto el laboratorio:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220402125618.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220406113813.png' | relative_url }}" text-align="center"/>
</div>

Y la mandamos al Intruder:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220406114351.png' | relative_url }}" text-align="center"/>
</div>

Teniendo en cuenta que rellenamos los payloads de la siguiente manera:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220406114826.png' | relative_url }}" text-align="center"/>
</div>

<br />

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220406114853.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220406154645.png' | relative_url }}" text-align="center"/>
</div>

De esta forma, tomamos el nombre y lo ponemos a probar con todas las contraseñas:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220406154830.png' | relative_url }}" text-align="center"/>
</div>

Debido a la falla, habrá una, la correcta, que no tendrá mensaje de error aunque esté bloqueada:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220406155414.png' | relative_url }}" text-align="center"/>
</div>

De esta manera las credenciales son: alerts:ginger

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220406155457.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220426202032.png' | relative_url }}" text-align="center"/>
</div>

Así, si tnemos una lista de candidatos a contraseñas podemos implementar una matriz JSON con todos los strings

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220426202136.png' | relative_url }}" text-align="center"/>
</div>

Y al mandar la request con BurpRepeater, obtendremos la siguiente respuesta:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220426202200.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220426202404.png' | relative_url }}" text-align="center"/>
</div>

Y copiamos la URL teniendo acceso a la sesión.

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220426202325.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220406183828.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220406184217.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220427095203.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220402181201.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220402193854.png' | relative_url }}" text-align="center"/>
</div>

Obteniendo finalmente:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220402193940.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220509204058.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220509204602.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220509210251.png' | relative_url }}" text-align="center"/>
</div>

Luego, introducimnos dicha cookie en nuestra cookie de stay-logged-in y entramos dentro del servidor:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220509210427.png' | relative_url }}" text-align="center"/>
</div>

Aunque, también podríamos haber decodeado la cookie con decodify y tener la contraseña de carlos:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220509210554.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220407104312.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220407104543.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220628135610.png' | relative_url }}" text-align="center"/>
</div>

Y en el email obtenemos:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220628135630.png' | relative_url }}" text-align="center"/>
</div>

De esta forma, podemos poner como valor la dirección de un servidor bajo nuestro control, en este caso: el exploit server:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220628140341.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220628140501.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220407121847.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220407130929.png' | relative_url }}" text-align="center"/>
</div>

Así, lanzamos la siguiente request

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220407131132.png' | relative_url }}" text-align="center"/>
</div>

Finalmente obtenemos:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220407131640.png' | relative_url }}" text-align="center"/>
</div>

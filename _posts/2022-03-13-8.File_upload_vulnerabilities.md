...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220412122749.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220412175211.png' | relative_url }}" text-align="center"/>
</div>

Aparace un mensaje informándonos de que el fichero se ha subido correctamente:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220412175246.png' | relative_url }}" text-align="center"/>
</div>

Y comprobamos que existe una pequeña muestra de la imagen que hemos subido al volver a My account:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220412175323.png' | relative_url }}" text-align="center"/>
</div>

Así pues, ahora generamos un fichero que contenga la línea de código php antes mencionada:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220412175754.png' | relative_url }}" text-align="center"/>
</div>

Y la subimos:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220412175526.png' | relative_url }}" text-align="center"/>
</div>

Obteniendo al ver la imagen:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220412175832.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220412191407.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220412195441.png' | relative_url }}" text-align="center"/>
</div>

Seguidamente aparecera un mensaje indicando que el fichero se ha subido correctamente:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220412195457.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220412195955.png' | relative_url }}" text-align="center"/>
</div>

Y accedemos a dicha dirección cambiando el nombre del archivo al que accedemos, obteniendo:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220412200011.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220413105058.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220413105223.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220413105949.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220413110633.png' | relative_url }}" text-align="center"/>
</div>

Y al subir el fichero obtendríamos el mensaje:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220413110708.png' | relative_url }}" text-align="center"/>
</div>

Así, accedemos a la localización del fichero que es un direectorio anterior a la localización por defecto:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220413110731.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220418123425.png' | relative_url }}" text-align="center"/>
</div>

Además, viendo la respuesta desde el http proxy history podemos observar que se trata un servidor Apache:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220418170103.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220418175830.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220418180216.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220418190839.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220418191350.png' | relative_url }}" text-align="center"/>
</div>

Obteniendo al acceder al fichero:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220418191416.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220418202118.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220418202518.png' | relative_url }}" text-align="center"/>
</div>

Y subimos dicho fichero:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220418202602.png' | relative_url }}" text-align="center"/>
</div>

Y accediendo al contenido:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220418202745.png' | relative_url }}" text-align="center"/>
</div>

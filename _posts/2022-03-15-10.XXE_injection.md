...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220421183832.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220421184141.png' | relative_url }}" text-align="center"/>
</div>

Al recibir la respuesta mediante el BurpRepeater obtenemos que falta un parámetro:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220421184209.png' | relative_url }}" text-align="center"/>
</div>

Añadimos la etiqueta de dicho parámetro:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220421184304.png' | relative_url }}" text-align="center"/>
</div>

Y obtenemos:

<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220421184330.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220518133811.png' | relative_url }}" text-align="center"/>
</div>
...
<div style="text-align:center">
	<img src="{{ '/assets/images/past-blogs/Burp/Pasted image 20220518133847.png' | relative_url }}" text-align="center"/>
</div>
